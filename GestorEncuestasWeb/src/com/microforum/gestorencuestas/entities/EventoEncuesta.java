...
public class EventoEncuesta {
	...
	@ElementCollection
	@JoinTable(name="REGISTRO_RESPUESTA_ENCUESTA",joinColumns=@JoinColumn(name="REF_EVENTO_ENCUESTA"))
	private Collection<RegistroRespuestaEncuesta> respuestas = new ArrayList<RegistroRespuestaEncuesta>();
